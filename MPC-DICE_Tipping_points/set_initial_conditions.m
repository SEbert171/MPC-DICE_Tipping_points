...
elseif  length(varargin) == 3 
     ...
     % initial conditions for auxiliary state variables
     mu0 = x_ini(18);  % initial mitigation rate == casadi var
     s0= x_ini(19); %  initial savings rate == casadi var
     Yedoma_triggered=SX(0);%state of the Yedoma tipping point
     Amazon_triggered=SX(0);%state of the Amazon tipping point
     Greenland_triggered=SX(0);%state of the Greenland tipping point
end
...
x_zero = [t0; x0; Params.sigma0; Params.L0; Params.A0; Params.EL0; Params.f0; ...
    Emissions0; C0; Yedoma_triggered;Amazon_triggered;Greenland_triggered; mu0; s0; 0];